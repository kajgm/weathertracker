# Weather Tracker &middot; [![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/kajgm/weathertracker/blob/master/LICENSE) ![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)
...
1. Install [Docker Engine](https://docs.docker.com/engine/install/)
   ...
   > Tip: If running on a Raspberry Pi, follow these docs: [install](https://docs.docker.com/engine/install/debian/)
...
1. If running these commands over ssh, set the $DISPLAY environment variable
...
2. To enable script auto start on boot, create an entry within `~/.config/autostart/.desktop` with the following lines:
   > Make sure to edit the `<username>` field
